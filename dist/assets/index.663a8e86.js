var C=Object.defineProperty,B=Object.defineProperties;var O=Object.getOwnPropertyDescriptors;var y=Object.getOwnPropertySymbols;var N=Object.prototype.hasOwnProperty,P=Object.prototype.propertyIsEnumerable;var z=(n,e,o)=>e in n?C(n,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):n[e]=o,A=(n,e)=>{for(var o in e||(e={}))N.call(e,o)&&z(n,o,e[o]);if(y)for(var o of y(e))P.call(e,o)&&z(n,o,e[o]);return n},E=(n,e)=>B(n,O(e));import{a as s,b as D,E as X,c as V,d as G,r as I,e as b,o as g,f as v,g as a,h as d,w as m,T as S,i as x,j as L,F as Y,k as h,m as q,l as H,n as M,p as W,q as U,s as Z,t as F}from"./vendor.fb903f24.js";const J=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))l(r);new MutationObserver(r=>{for(const t of r)if(t.type==="childList")for(const i of t.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&l(i)}).observe(document,{childList:!0,subtree:!0});function o(r){const t={};return r.integrity&&(t.integrity=r.integrity),r.referrerpolicy&&(t.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?t.credentials="include":r.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function l(r){if(r.ep)return;r.ep=!0;const t=o(r);fetch(r.href,t)}};J();const Q="modulepreload",j={},K="/",w=function(e,o){return!o||o.length===0?e():Promise.all(o.map(l=>{if(l=`${K}${l}`,l in j)return;j[l]=!0;const r=l.endsWith(".css"),t=r?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${t}`))return;const i=document.createElement("link");if(i.rel=r?"stylesheet":Q,r||(i.as="script",i.crossOrigin=""),i.href=l,document.head.appendChild(i),r)return new Promise((c,u)=>{i.addEventListener("load",c),i.addEventListener("error",u)})})).then(()=>e())},nn=()=>({sidebar:{opened:s.get("sidebarStatus")?!!+s.get("sidebarStatus"):!0,withoutAnimation:!1},device:"desktop",size:s.get("size")||"medium",windowsWidth:960,lang:"zh-tw"}),en={TOGGLE_SIDEBAR:n=>{n.sidebar.opened=!n.sidebar.opened,n.sidebar.withoutAnimation=!1,n.sidebar.opened?s.set("sidebarStatus",1):s.set("sidebarStatus",0)},CLOSE_SIDEBAR:(n,e)=>{s.set("sidebarStatus",0),n.sidebar.opened=!1,n.sidebar.withoutAnimation=e},TOGGLE_DEVICE:(n,e)=>{n.device=e},SET_SIZE:(n,e)=>{n.size=e,s.set("size",e)},SET_WINDOWS_WIDTH:(n,e)=>{n.windowsWidth=e},SET_LANG:(n,e)=>{n.lang=e,localStorage.setItem("lang",JSON.stringify(e))}},on={toggleSideBar({commit:n}){n("TOGGLE_SIDEBAR")},closeSideBar({commit:n},{withoutAnimation:e}){n("CLOSE_SIDEBAR",e)},toggleDevice({commit:n},e){n("TOGGLE_DEVICE",e)},setSize({commit:n},e){n("SET_SIZE",e)},setWindowsWidth({commit:n},e){n("SET_WINDOWS_WIDTH",e)},changeLang({dispatch:n,commit:e,rootGetters:o},l){return new Promise(r=>{e("SET_LANG",l),r()})}},ln={sidebar:(n,e)=>n.sidebar,device:(n,e)=>n.device,size:(n,e)=>n.size,windowsWidth:(n,e)=>n.windowsWidth,lang:(n,e)=>n.lang};var rn={namespaced:!0,state:nn,getters:ln,mutations:en,actions:on},tn=`/**
...
:export {
  theme: #1890ff;
}`;const an={title:"",showSettings:!0,tagsView:!0,fixedHeader:!0,sidebarLogo:!1,errorLog:"production"},{showSettings:cn,tagsView:sn,fixedHeader:dn,sidebarLogo:pn}=an,bn=()=>({theme:tn.theme,showSettings:cn,tagsView:sn,fixedHeader:dn,sidebarLogo:pn}),gn={CHANGE_SETTING:(n,{key:e,value:o})=>{n.hasOwnProperty(e)&&(n[e]=o)}},fn={changeSetting({commit:n},e){n("CHANGE_SETTING",e)}},un={theme:(n,e)=>n.theme,showSettings:(n,e)=>n.showSettings,tagsView:(n,e)=>n.tagsView,fixedHeader:(n,e)=>n.fixedHeader,sidebarLogo:(n,e)=>n.sidebarLogo};var hn={namespaced:!0,state:bn,getters:un,mutations:gn,actions:fn};const mn=()=>({logs:[]}),_n={ADD_ERROR_LOG:(n,e)=>{n.logs.push(e)},CLEAR_ERROR_LOG:n=>{n.logs.splice(0)}},vn={addErrorLog({commit:n},e){n("ADD_ERROR_LOG",e)},clearErrorLog({commit:n}){n("CLEAR_ERROR_LOG")}},xn={errorLogs:(n,e)=>n.logs};var wn={namespaced:!0,state:mn,getters:xn,mutations:_n,actions:vn};const p=D.create({baseURL:{}.VITE_API_BASE_URL,withCredentials:!0,timeout:1e3*60*3,crossDomain:!0,headers:{"Access-Control-Allow-Credentials":!0,"Access-Control-Allow-Headers":"X-Requested-With, Content-Type, Set-Cookie, cross-site","Access-Control-Allow-Methods":"PUT,POST,GET,DELETE,OPTIONS"}});p.interceptors.request.use(n=>{var e=f.getters["user/token"];return e&&(n.headers.authorization="Bearer "+e),n},n=>(console.log(n),Promise.reject(n)));p.interceptors.response.use(n=>{const e=n;return e.status!==2e4&&e.status!==200?(Message({message:e.message||"Error",type:"error",duration:5*1e3}),(e.status===50008||e.status===50012||e.status===50014||e.status===403)&&X.confirm("You have been logged out, you can cancel to stay on this page, or log in again","Confirm logout",{confirmButtonText:"Re-Login",cancelButtonText:"Cancel",type:"warning"}).then(()=>{console.log("resetToken!!")}),Promise.reject(new Error(e.message||"Error"))):e.data},n=>(n.response.status==401&&(V({message:"\u61C9\u7528\u7A0B\u5F0F\u5DF2\u9592\u7F6E\u8D85\u6642",type:"error",duration:5*1e3}),f.dispatch("user/resetToken").then(()=>{location.reload()})),Promise.reject(n)));p.defaults.headers.common["Access-Control-Allow-Origin"]="*";p.defaults.headers.common["Access-Control-Allow-Credentials"]="true";p.defaults.headers.common["Access-Control-Allow-Headers"]="X-Requested-With, Content-Type";p.defaults.headers.common["Access-Control-Allow-Methods"]="PUT,POST,GET,DELETE,OPTIONS";const kn=()=>p({url:"/api/Page",method:"get"}),yn="book-rgp-pages",zn=()=>({page:{},pageNumber:0,pages:[]}),An={setPage:(n,e)=>{n.page=n.pages[e],n.pageNumber=e+1,sessionStorage.setItem("page",JSON.stringify(n.page)),sessionStorage.setItem("pageNumber",JSON.stringify(n.pageNumber))},setPages:(n,e)=>{localStorage.setItem(yn,JSON.stringify(e)),n.pages=e}},En={getPage({commit:n,state:e,dispatch:o},l){return new Promise((r,t)=>{console.log(e.pages),e.pages.length===0&&o("getPages"),n("setPage",l-1)})},getPages({commit:n}){return new Promise((e,o)=>{kn().then(l=>{n("setPages",l),n("setPage",0),e(l)}).catch(l=>{o(l)})})}},In={currentPage:n=>n.page,currentPageNumber:n=>n.pageNumber};var Sn={namespaced:!0,state:zn,getters:In,mutations:An,actions:En};const Ln=!1,Yn=G({modules:{app:rn,settings:hn,errorLog:wn,page:Sn},strict:Ln,plugins:[]});var f=Yn;const{body:k}=document,jn=992;var R={watch:{$route(){}},beforeMount(){window.addEventListener("resize",this.$_resizeHandler)},beforeDestroy(){window.removeEventListener("resize",this.$_resizeHandler)},mounted(){const n=k.getElementsByClassName("app-main")[0].getBoundingClientRect();f.dispatch("app/setWindowsWidth",n.width)},methods:{$_isMobile(){return k.getBoundingClientRect().width-1<jn},$_resizeHandler(){if(!document.hidden){const n=this.$_isMobile();f.dispatch("app/toggleDevice",n?"mobile":"desktop");const e=k.getElementsByClassName("app-main")[0].getBoundingClientRect();f.dispatch("app/setWindowsWidth",e.width)}}}};var _=(n,e)=>{const o=n.__vccOpts||n;for(const[l,r]of e)o[l]=r;return o};const Rn={components:{},mixins:[R],setup(){const n=I(!1),e=I({});return{show:n,refDom:e,beforeEnter:o=>{console.log("beforeEnter",o.className)},enter:(o,l)=>{console.log("enter",o.className,e),console.log(e.value.getElementsByClassName("right")),l()},leave:(o,l)=>{var r=e.value.getElementsByClassName("right")[0];r.classList.add("turn-right");var t=r.children[0];t.classList.add("hide-content"),setTimeout(()=>{l()},1e3)}}}},$n={class:"wrapper"},Tn={id:"container"},Cn={class:"open-book"},Bn={class:"page",ref:"refDom"},On={class:"app-main"},Nn=a("footer",null,[a("div",null,[h("Icons made by "),a("a",{href:"https://www.flaticon.com/authors/justicon",title:"justicon"},"justicon"),h(" from "),a("a",{href:"https://www.flaticon.com/",title:"Flaticon"},"www.flaticon.com")])],-1);function Pn(n,e,o,l,r,t){const i=b("router-view"),c=b("el-backtop");return g(),v(Y,null,[a("div",$n,[a("div",Tn,[a("div",Cn,[d(i,null,{default:m(({Component:u,route:T})=>[a("div",Bn,[a("div",On,[d(S,{name:"turn",mode:"out-in",onBeforeEnter:l.beforeEnter,onEnter:l.enter,onLeave:l.leave,duration:{enter:2e3,leave:2e3}},{default:m(()=>[(g(),x(L(u),{key:T.path}))]),_:2},1032,["onBeforeEnter","onEnter","onLeave"])])],512)]),_:1})])]),d(c)]),Nn],64)}var Dn=_(Rn,[["render",Pn]]);const Xn={name:"AppMain"},Vn={class:"app-main"};function Gn(n,e,o,l,r,t){const i=b("router-view");return g(),v("section",Vn,[d(i,null,{default:m(({Component:c,route:u})=>[(g(),x(L(c),{key:u.path}))]),_:1})])}var qn=_(Xn,[["render",Gn],["__scopeId","data-v-1eb1abee"]]);const Hn={name:"Layout",components:{AppMain:qn},mixins:[R],computed:E(A({},q({device:n=>n.app.device,showSettings:n=>n.settings.showSettings,needTagsView:n=>n.settings.tagsView,fixedHeader:n=>n.settings.fixedHeader})),{classObj(){return{mobile:this.device==="mobile"}}}),methods:{}},Mn={class:"wrapper"},Wn={id:"container"},Un=h(" = "),Zn=a("footer",null,[a("div",null,[h("Icons made by "),a("a",{href:"https://www.flaticon.com/authors/justicon",title:"justicon"},"justicon"),h(" from "),a("a",{href:"https://www.flaticon.com/",title:"Flaticon"},"www.flaticon.com")])],-1);function Fn(n,e,o,l,r,t){const i=b("app-main"),c=b("el-backtop");return g(),v(Y,null,[a("div",Mn,[a("div",Wn,[d(S,{name:"fade"},{default:m(()=>[d(i)]),_:1}),Un]),d(c)]),Zn],64)}var Jn=_(Hn,[["render",Fn]]);const Qn=[{path:"/:pathMatch(.*)*",component:()=>w(()=>import("./index.823f011e.js"),["assets/index.823f011e.js","assets/index.6a2b41c4.css","assets/vendor.fb903f24.js"]),name:"NotFound"},{path:"/",component:Jn,redirect:"/home",children:[{path:"home",component:()=>w(()=>import("./index.6784a3bc.js"),["assets/index.6784a3bc.js","assets/index.f6e82a3c.css","assets/vendor.fb903f24.js"]),name:"Home",meta:{title:"\u9996\u9801",icon:"el-icon-house",affix:!0}}]},{path:"/Page",component:Dn,children:[{path:":id",component:()=>w(()=>import("./index.90a3dde0.js"),["assets/index.90a3dde0.js","assets/index.43306c9d.css","assets/vendor.fb903f24.js"]),name:"Page",meta:{affix:!0},props:n=>({id:n.params.id})}]}],Kn={}.VITE_BASE,ne=H({history:M(Kn),routes:Qn}),ee={name:"App",provide(){return{reload:this.reload}},data(){return{isRouterAlive:!0}},methods:{reload(){this.isRouterAlive=!1,this.$nextTick(()=>{this.isRouterAlive=!0})}}};function oe(n,e,o,l,r,t){const i=b("router-view");return r.isRouterAlive?(g(),x(i,{key:0})):W("",!0)}var le=_(ee,[["render",oe]]);const $=U(le).use(f).use(ne).use(Z);$.config.globalProperties.$filters={formatDate:n=>{if(n)return F(String(n)).format("YYYY/MM/DD hh:mm")}};$.mount("#app");export{_};
