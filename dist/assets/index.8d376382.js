var L=Object.defineProperty,R=Object.defineProperties;var j=Object.getOwnPropertyDescriptors;var x=Object.getOwnPropertySymbols;var $=Object.prototype.hasOwnProperty,T=Object.prototype.propertyIsEnumerable;var w=(n,e,o)=>e in n?L(n,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):n[e]=o,k=(n,e)=>{for(var o in e||(e={}))$.call(e,o)&&w(n,o,e[o]);if(x)for(var o of x(e))T.call(e,o)&&w(n,o,e[o]);return n},y=(n,e)=>R(n,j(e));import{r as b,o as g,c as z,a as u,w as C,b as h,d as A,e as B,f as c,g as O,E as D,h as P,i as X,j as N,m as G,k as d,F as V,l as E,n as q,p as H,q as M,s as W,t as U}from"./vendor.a32da68b.js";const Z=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))r(l);new MutationObserver(l=>{for(const i of l)if(i.type==="childList")for(const t of i.addedNodes)t.tagName==="LINK"&&t.rel==="modulepreload"&&r(t)}).observe(document,{childList:!0,subtree:!0});function o(l){const i={};return l.integrity&&(i.integrity=l.integrity),l.referrerpolicy&&(i.referrerPolicy=l.referrerpolicy),l.crossorigin==="use-credentials"?i.credentials="include":l.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(l){if(l.ep)return;l.ep=!0;const i=o(l);fetch(l.href,i)}};Z();const F="modulepreload",I={},J="/my-vue-app/",m=function(e,o){return!o||o.length===0?e():Promise.all(o.map(r=>{if(r=`${J}${r}`,r in I)return;I[r]=!0;const l=r.endsWith(".css"),i=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${i}`))return;const t=document.createElement("link");if(t.rel=l?"stylesheet":F,l||(t.as="script",t.crossOrigin=""),t.href=r,document.head.appendChild(t),l)return new Promise((p,f)=>{t.addEventListener("load",p),t.addEventListener("error",f)})})).then(()=>e())};var _=(n,e)=>{const o=n.__vccOpts||n;for(const[r,l]of e)o[r]=l;return o};const Q={name:"AppMain"},K={class:"app-main"};function nn(n,e,o,r,l,i){const t=b("router-view");return g(),z("section",K,[u(t,null,{default:C(({Component:p,route:f})=>[h(" <keep-alive> "),(g(),A(B(p),{key:f.path})),h(" </keep-alive> ")]),_:1})])}var en=_(Q,[["render",nn],["__scopeId","data-v-078753dd"]]);const on=()=>({sidebar:{opened:c.get("sidebarStatus")?!!+c.get("sidebarStatus"):!0,withoutAnimation:!1},device:"desktop",size:c.get("size")||"medium",windowsWidth:960,lang:"zh-tw"}),ln={TOGGLE_SIDEBAR:n=>{n.sidebar.opened=!n.sidebar.opened,n.sidebar.withoutAnimation=!1,n.sidebar.opened?c.set("sidebarStatus",1):c.set("sidebarStatus",0)},CLOSE_SIDEBAR:(n,e)=>{c.set("sidebarStatus",0),n.sidebar.opened=!1,n.sidebar.withoutAnimation=e},TOGGLE_DEVICE:(n,e)=>{n.device=e},SET_SIZE:(n,e)=>{n.size=e,c.set("size",e)},SET_WINDOWS_WIDTH:(n,e)=>{n.windowsWidth=e},SET_LANG:(n,e)=>{n.lang=e,localStorage.setItem("lang",JSON.stringify(e))}},rn={toggleSideBar({commit:n}){n("TOGGLE_SIDEBAR")},closeSideBar({commit:n},{withoutAnimation:e}){n("CLOSE_SIDEBAR",e)},toggleDevice({commit:n},e){n("TOGGLE_DEVICE",e)},setSize({commit:n},e){n("SET_SIZE",e)},setWindowsWidth({commit:n},e){n("SET_WINDOWS_WIDTH",e)},changeLang({dispatch:n,commit:e,rootGetters:o},r){return new Promise(l=>{e("SET_LANG",r),l()})}},tn={sidebar:(n,e)=>n.sidebar,device:(n,e)=>n.device,size:(n,e)=>n.size,windowsWidth:(n,e)=>n.windowsWidth,lang:(n,e)=>n.lang};var an={namespaced:!0,state:on,getters:tn,mutations:ln,actions:rn},cn=`/**
...
:export {
  theme: #1890ff;
}`;const sn={title:"",showSettings:!0,tagsView:!0,fixedHeader:!0,sidebarLogo:!1,errorLog:"production"},{showSettings:dn,tagsView:pn,fixedHeader:bn,sidebarLogo:gn}=sn,fn=()=>({theme:cn.theme,showSettings:dn,tagsView:pn,fixedHeader:bn,sidebarLogo:gn}),un={CHANGE_SETTING:(n,{key:e,value:o})=>{n.hasOwnProperty(e)&&(n[e]=o)}},hn={changeSetting({commit:n},e){n("CHANGE_SETTING",e)}},mn={theme:(n,e)=>n.theme,showSettings:(n,e)=>n.showSettings,tagsView:(n,e)=>n.tagsView,fixedHeader:(n,e)=>n.fixedHeader,sidebarLogo:(n,e)=>n.sidebarLogo};var _n={namespaced:!0,state:fn,getters:mn,mutations:un,actions:hn};const vn=()=>({logs:[]}),xn={ADD_ERROR_LOG:(n,e)=>{n.logs.push(e)},CLEAR_ERROR_LOG:n=>{n.logs.splice(0)}},wn={addErrorLog({commit:n},e){n("ADD_ERROR_LOG",e)},clearErrorLog({commit:n}){n("CLEAR_ERROR_LOG")}},kn={errorLogs:(n,e)=>n.logs};var yn={namespaced:!0,state:vn,getters:kn,mutations:xn,actions:wn};const s=O.create({baseURL:"",withCredentials:!0,timeout:1e3*60*3,crossDomain:!0,headers:{"Access-Control-Allow-Credentials":!0,"Access-Control-Allow-Headers":"X-Requested-With, Content-Type, Set-Cookie, cross-site","Access-Control-Allow-Methods":"PUT,POST,GET,DELETE,OPTIONS"}});s.interceptors.request.use(n=>{var e=a.getters["user/token"];return e&&(n.headers.authorization="Bearer "+e),n},n=>(console.log(n),Promise.reject(n)));s.interceptors.response.use(n=>{const e=n;return e.status!==2e4&&e.status!==200?(Message({message:e.message||"Error",type:"error",duration:5*1e3}),(e.status===50008||e.status===50012||e.status===50014||e.status===403)&&D.confirm("You have been logged out, you can cancel to stay on this page, or log in again","Confirm logout",{confirmButtonText:"Re-Login",cancelButtonText:"Cancel",type:"warning"}).then(()=>{console.log("resetToken!!")}),Promise.reject(new Error(e.message||"Error"))):e.data},n=>(n.response.status==401&&(P({message:"\u61C9\u7528\u7A0B\u5F0F\u5DF2\u9592\u7F6E\u8D85\u6642",type:"error",duration:5*1e3}),a.dispatch("user/resetToken").then(()=>{location.reload()})),Promise.reject(n)));s.defaults.headers.common["Access-Control-Allow-Origin"]="*";s.defaults.headers.common["Access-Control-Allow-Credentials"]="true";s.defaults.headers.common["Access-Control-Allow-Headers"]="X-Requested-With, Content-Type";s.defaults.headers.common["Access-Control-Allow-Methods"]="PUT,POST,GET,DELETE,OPTIONS";const zn=()=>s({url:"/api/Page",method:"get"}),An=()=>({page:{},pageNumber:0,pages:[]}),En={setPage:(n,e)=>{n.page=n.pages[e],n.pageNumber=e*2+1},setPages:(n,e)=>{n.pages=e}},In={next({commit:n}){return new Promise((e,o)=>{fetchPage().then(r=>{n("setPages",r),e(r)}).catch(r=>{o(r)})})},getPages({commit:n}){return new Promise((e,o)=>{zn().then(r=>{n("setPages",r),n("setPage",0),e(r)}).catch(r=>{o(r)})})}},Sn={currentPage:n=>n.page,currentPageNumber:n=>n.pageNumber};var Yn={namespaced:!0,state:An,getters:Sn,mutations:En,actions:In};const Ln=!0,Rn=X({modules:{app:an,settings:_n,errorLog:yn,page:Yn},strict:Ln,plugins:[N()]});var a=Rn;const{body:v}=document,jn=992;var $n={watch:{$route(){this.device==="mobile"&&this.sidebar.opened&&a.dispatch("app/closeSideBar",{withoutAnimation:!1})}},beforeMount(){window.addEventListener("resize",this.$_resizeHandler)},beforeDestroy(){window.removeEventListener("resize",this.$_resizeHandler)},mounted(){const n=this.$_isMobile(),e=v.getElementsByClassName("app-main")[0].getBoundingClientRect();a.dispatch("app/setWindowsWidth",e.width),n&&(a.dispatch("app/toggleDevice","mobile"),a.dispatch("app/closeSideBar",{withoutAnimation:!0}))},methods:{$_isMobile(){return v.getBoundingClientRect().width-1<jn},$_resizeHandler(){if(!document.hidden){const n=this.$_isMobile();a.dispatch("app/toggleDevice",n?"mobile":"desktop");const e=v.getElementsByClassName("app-main")[0].getBoundingClientRect();a.dispatch("app/setWindowsWidth",e.width),n&&a.dispatch("app/closeSideBar",{withoutAnimation:!0})}}}};const Tn={name:"Layout",components:{AppMain:en},mixins:[$n],computed:y(k({},G({device:n=>n.app.device,showSettings:n=>n.settings.showSettings,needTagsView:n=>n.settings.tagsView,fixedHeader:n=>n.settings.fixedHeader})),{classObj(){return{mobile:this.device==="mobile"}}}),methods:{}},Cn={class:"wrapper"},Bn={id:"container"},On=d("footer",null,[d("div",null,[E("Icons made by "),d("a",{href:"https://www.flaticon.com/authors/justicon",title:"justicon"},"justicon"),E(" from "),d("a",{href:"https://www.flaticon.com/",title:"Flaticon"},"www.flaticon.com")])],-1);function Dn(n,e,o,r,l,i){const t=b("app-main"),p=b("el-backtop");return g(),z(V,null,[d("div",Cn,[d("div",Bn,[u(t)]),u(p)]),On],64)}var S=_(Tn,[["render",Dn]]);const Pn=[{path:"/:pathMatch(.*)*",component:()=>m(()=>import("./index.486dd0f2.js"),["assets/index.486dd0f2.js","assets/index.b078be90.css","assets/vendor.a32da68b.js"]),name:"NotFound"},{path:"/",component:S,redirect:"/home",children:[{path:"home",component:()=>m(()=>import("./index.9b617bd1.js"),["assets/index.9b617bd1.js","assets/vendor.a32da68b.js","assets/index.dd6b8359.js","assets/index.1ff5e983.css"]),name:"Home",meta:{title:"\u9996\u9801",icon:"el-icon-house",affix:!0}}]},{path:"/Page",component:S,children:[{path:":id",component:()=>m(()=>import("./index.88450d9e.js"),["assets/index.88450d9e.js","assets/vendor.a32da68b.js","assets/index.dd6b8359.js","assets/index.1ff5e983.css"]),name:"Page",meta:{title:"\u9996\u9801",icon:"el-icon-house",affix:!0}}]}],Xn="/my-vue-app",Nn=q({history:H(Xn),routes:Pn}),Gn={name:"App",provide(){return{reload:this.reload}},data(){return{isRouterAlive:!0}},methods:{reload(){this.isRouterAlive=!1,this.$nextTick(()=>{this.isRouterAlive=!0})}}};function Vn(n,e,o,r,l,i){const t=b("router-view");return l.isRouterAlive?(g(),A(t,{key:0})):h("v-if",!0)}var qn=_(Gn,[["render",Vn]]);const Y=M(qn).use(a).use(Nn).use(W);Y.config.globalProperties.$filters={formatDate:n=>{if(n)return U(String(n)).format("YYYY/MM/DD hh:mm")}};Y.mount("#app");export{_};
