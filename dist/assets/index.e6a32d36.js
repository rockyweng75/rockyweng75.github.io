var Y=Object.defineProperty,L=Object.defineProperties;var R=Object.getOwnPropertyDescriptors;var v=Object.getOwnPropertySymbols;var j=Object.prototype.hasOwnProperty,T=Object.prototype.propertyIsEnumerable;var x=(n,e,o)=>e in n?Y(n,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):n[e]=o,w=(n,e)=>{for(var o in e||(e={}))j.call(e,o)&&x(n,o,e[o]);if(v)for(var o of v(e))T.call(e,o)&&x(n,o,e[o]);return n},k=(n,e)=>L(n,R(e));import{r as b,o as g,c as y,a as u,w as $,b as z,d as B,e as c,f as C,E as O,g as P,h as D,m as X,i as d,F as N,j as A,k as V,l as G,n as q,p as H,q as M,s as W}from"./vendor.ebb25b07.js";const U=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))r(l);new MutationObserver(l=>{for(const i of l)if(i.type==="childList")for(const t of i.addedNodes)t.tagName==="LINK"&&t.rel==="modulepreload"&&r(t)}).observe(document,{childList:!0,subtree:!0});function o(l){const i={};return l.integrity&&(i.integrity=l.integrity),l.referrerpolicy&&(i.referrerPolicy=l.referrerpolicy),l.crossorigin==="use-credentials"?i.credentials="include":l.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(l){if(l.ep)return;l.ep=!0;const i=o(l);fetch(l.href,i)}};U();const Z="modulepreload",E={},F="/",h=function(e,o){return!o||o.length===0?e():Promise.all(o.map(r=>{if(r=`${F}${r}`,r in E)return;E[r]=!0;const l=r.endsWith(".css"),i=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${i}`))return;const t=document.createElement("link");if(t.rel=l?"stylesheet":Z,l||(t.as="script",t.crossOrigin=""),t.href=r,document.head.appendChild(t),l)return new Promise((p,f)=>{t.addEventListener("load",p),t.addEventListener("error",f)})})).then(()=>e())};var m=(n,e)=>{const o=n.__vccOpts||n;for(const[r,l]of e)o[r]=l;return o};const J={name:"AppMain"},Q={class:"app-main"};function K(n,e,o,r,l,i){const t=b("router-view");return g(),y("section",Q,[u(t,null,{default:$(({Component:p,route:f})=>[(g(),z(B(p),{key:f.path}))]),_:1})])}var nn=m(J,[["render",K],["__scopeId","data-v-1eb1abee"]]);const en=()=>({sidebar:{opened:c.get("sidebarStatus")?!!+c.get("sidebarStatus"):!0,withoutAnimation:!1},device:"desktop",size:c.get("size")||"medium",windowsWidth:960,lang:"zh-tw"}),on={TOGGLE_SIDEBAR:n=>{n.sidebar.opened=!n.sidebar.opened,n.sidebar.withoutAnimation=!1,n.sidebar.opened?c.set("sidebarStatus",1):c.set("sidebarStatus",0)},CLOSE_SIDEBAR:(n,e)=>{c.set("sidebarStatus",0),n.sidebar.opened=!1,n.sidebar.withoutAnimation=e},TOGGLE_DEVICE:(n,e)=>{n.device=e},SET_SIZE:(n,e)=>{n.size=e,c.set("size",e)},SET_WINDOWS_WIDTH:(n,e)=>{n.windowsWidth=e},SET_LANG:(n,e)=>{n.lang=e,localStorage.setItem("lang",JSON.stringify(e))}},ln={toggleSideBar({commit:n}){n("TOGGLE_SIDEBAR")},closeSideBar({commit:n},{withoutAnimation:e}){n("CLOSE_SIDEBAR",e)},toggleDevice({commit:n},e){n("TOGGLE_DEVICE",e)},setSize({commit:n},e){n("SET_SIZE",e)},setWindowsWidth({commit:n},e){n("SET_WINDOWS_WIDTH",e)},changeLang({dispatch:n,commit:e,rootGetters:o},r){return new Promise(l=>{e("SET_LANG",r),l()})}},rn={sidebar:(n,e)=>n.sidebar,device:(n,e)=>n.device,size:(n,e)=>n.size,windowsWidth:(n,e)=>n.windowsWidth,lang:(n,e)=>n.lang};var tn={namespaced:!0,state:en,getters:rn,mutations:on,actions:ln},an=`/**
...
:export {
  theme: #1890ff;
}`;const cn={title:"",showSettings:!0,tagsView:!0,fixedHeader:!0,sidebarLogo:!1,errorLog:"production"},{showSettings:sn,tagsView:dn,fixedHeader:pn,sidebarLogo:bn}=cn,gn=()=>({theme:an.theme,showSettings:sn,tagsView:dn,fixedHeader:pn,sidebarLogo:bn}),fn={CHANGE_SETTING:(n,{key:e,value:o})=>{n.hasOwnProperty(e)&&(n[e]=o)}},un={changeSetting({commit:n},e){n("CHANGE_SETTING",e)}},hn={theme:(n,e)=>n.theme,showSettings:(n,e)=>n.showSettings,tagsView:(n,e)=>n.tagsView,fixedHeader:(n,e)=>n.fixedHeader,sidebarLogo:(n,e)=>n.sidebarLogo};var mn={namespaced:!0,state:gn,getters:hn,mutations:fn,actions:un};const _n=()=>({logs:[]}),vn={ADD_ERROR_LOG:(n,e)=>{n.logs.push(e)},CLEAR_ERROR_LOG:n=>{n.logs.splice(0)}},xn={addErrorLog({commit:n},e){n("ADD_ERROR_LOG",e)},clearErrorLog({commit:n}){n("CLEAR_ERROR_LOG")}},wn={errorLogs:(n,e)=>n.logs};var kn={namespaced:!0,state:_n,getters:wn,mutations:vn,actions:xn};const s=C.create({baseURL:{}.VITE_API_BASE_URL,withCredentials:!0,timeout:1e3*60*3,crossDomain:!0,headers:{"Access-Control-Allow-Credentials":!0,"Access-Control-Allow-Headers":"X-Requested-With, Content-Type, Set-Cookie, cross-site","Access-Control-Allow-Methods":"PUT,POST,GET,DELETE,OPTIONS"}});s.interceptors.request.use(n=>{var e=a.getters["user/token"];return e&&(n.headers.authorization="Bearer "+e),n},n=>(console.log(n),Promise.reject(n)));s.interceptors.response.use(n=>{const e=n;return e.status!==2e4&&e.status!==200?(Message({message:e.message||"Error",type:"error",duration:5*1e3}),(e.status===50008||e.status===50012||e.status===50014||e.status===403)&&O.confirm("You have been logged out, you can cancel to stay on this page, or log in again","Confirm logout",{confirmButtonText:"Re-Login",cancelButtonText:"Cancel",type:"warning"}).then(()=>{console.log("resetToken!!")}),Promise.reject(new Error(e.message||"Error"))):e.data},n=>(n.response.status==401&&(P({message:"\u61C9\u7528\u7A0B\u5F0F\u5DF2\u9592\u7F6E\u8D85\u6642",type:"error",duration:5*1e3}),a.dispatch("user/resetToken").then(()=>{location.reload()})),Promise.reject(n)));s.defaults.headers.common["Access-Control-Allow-Origin"]="*";s.defaults.headers.common["Access-Control-Allow-Credentials"]="true";s.defaults.headers.common["Access-Control-Allow-Headers"]="X-Requested-With, Content-Type";s.defaults.headers.common["Access-Control-Allow-Methods"]="PUT,POST,GET,DELETE,OPTIONS";const yn=()=>s({url:"/api/Page",method:"get"}),zn=()=>({page:{},pageNumber:0,pages:[]}),An={setPage:(n,e)=>{n.page=n.pages[e],n.pageNumber=e*2+1},setPages:(n,e)=>{n.pages=e}},En={next({commit:n}){return new Promise((e,o)=>{fetchPage().then(r=>{n("setPages",r),e(r)}).catch(r=>{o(r)})})},getPages({commit:n}){return new Promise((e,o)=>{yn().then(r=>{n("setPages",r),n("setPage",0),e(r)}).catch(r=>{o(r)})})}},In={currentPage:n=>n.page,currentPageNumber:n=>n.pageNumber};var Sn={namespaced:!0,state:zn,getters:In,mutations:An,actions:En};const Yn=!1,Ln=D({modules:{app:tn,settings:mn,errorLog:kn,page:Sn},strict:Yn,plugins:[]});var a=Ln;const{body:_}=document,Rn=992;var jn={watch:{$route(){this.device==="mobile"&&this.sidebar.opened&&a.dispatch("app/closeSideBar",{withoutAnimation:!1})}},beforeMount(){window.addEventListener("resize",this.$_resizeHandler)},beforeDestroy(){window.removeEventListener("resize",this.$_resizeHandler)},mounted(){const n=this.$_isMobile(),e=_.getElementsByClassName("app-main")[0].getBoundingClientRect();a.dispatch("app/setWindowsWidth",e.width),n&&(a.dispatch("app/toggleDevice","mobile"),a.dispatch("app/closeSideBar",{withoutAnimation:!0}))},methods:{$_isMobile(){return _.getBoundingClientRect().width-1<Rn},$_resizeHandler(){if(!document.hidden){const n=this.$_isMobile();a.dispatch("app/toggleDevice",n?"mobile":"desktop");const e=_.getElementsByClassName("app-main")[0].getBoundingClientRect();a.dispatch("app/setWindowsWidth",e.width),n&&a.dispatch("app/closeSideBar",{withoutAnimation:!0})}}}};const Tn={name:"Layout",components:{AppMain:nn},mixins:[jn],computed:k(w({},X({device:n=>n.app.device,showSettings:n=>n.settings.showSettings,needTagsView:n=>n.settings.tagsView,fixedHeader:n=>n.settings.fixedHeader})),{classObj(){return{mobile:this.device==="mobile"}}}),methods:{}},$n={class:"wrapper"},Bn={id:"container"},Cn=d("footer",null,[d("div",null,[A("Icons made by "),d("a",{href:"https://www.flaticon.com/authors/justicon",title:"justicon"},"justicon"),A(" from "),d("a",{href:"https://www.flaticon.com/",title:"Flaticon"},"www.flaticon.com")])],-1);function On(n,e,o,r,l,i){const t=b("app-main"),p=b("el-backtop");return g(),y(N,null,[d("div",$n,[d("div",Bn,[u(t)]),u(p)]),Cn],64)}var I=m(Tn,[["render",On]]);const Pn=[{path:"/:pathMatch(.*)*",component:()=>h(()=>import("./index.f6a566f5.js"),["assets/index.f6a566f5.js","assets/index.6a2b41c4.css","assets/vendor.ebb25b07.js"]),name:"NotFound"},{path:"/",component:I,redirect:"/home",children:[{path:"home",component:()=>h(()=>import("./index.0dc1f537.js"),["assets/index.0dc1f537.js","assets/index.c58db930.css","assets/vendor.ebb25b07.js"]),name:"Home",meta:{title:"\u9996\u9801",icon:"el-icon-house",affix:!0}}]},{path:"/Page",component:I,children:[{path:":id",component:()=>h(()=>import("./index.160e2894.js"),["assets/index.160e2894.js","assets/index.d6c1e493.css","assets/vendor.ebb25b07.js"]),name:"Page",meta:{title:"\u9996\u9801",icon:"el-icon-house",affix:!0}}]}],Dn={}.VITE_BASE,Xn=V({history:G(Dn),routes:Pn}),Nn={name:"App",provide(){return{reload:this.reload}},data(){return{isRouterAlive:!0}},methods:{reload(){this.isRouterAlive=!1,this.$nextTick(()=>{this.isRouterAlive=!0})}}};function Vn(n,e,o,r,l,i){const t=b("router-view");return l.isRouterAlive?(g(),z(t,{key:0})):q("",!0)}var Gn=m(Nn,[["render",Vn]]);const S=H(Gn).use(a).use(Xn).use(M);S.config.globalProperties.$filters={formatDate:n=>{if(n)return W(String(n)).format("YYYY/MM/DD hh:mm")}};S.mount("#app");export{m as _};
